...
const FilterPanel: React.FC<FilterPanelProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-start justify-end">
      <div className="bg-white w-full sm:w-80 h-full shadow-2xl transform transition-transform overflow-y-auto">
        ...
        <div className="p-4 sm:p-6 space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-qawli-500 focus:border-transparent text-sm"
            />
          </div>
            ...
            <div className="flex flex-wrap gap-2">
              {['wahyu pertama', 'perang', 'hijrah', 'dakwah', 'kemenangan'].map((tag) => (
                <button
                  ...
                  className="px-3 py-1.5 text-xs bg-qawli-50 text-qawli-700 rounded-full hover:bg-qawli-100 transition-colors"
                >
                  {tag}
                </button>
              ))}
